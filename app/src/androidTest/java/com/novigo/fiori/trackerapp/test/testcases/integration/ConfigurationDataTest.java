package com.novigo.fiori.trackerapp.test.testcases.integration;
...
public class ConfigurationDataTest {
    ...
    private static String GOOD_URL = "https://hcpms-s0021300906trial.hanatrial.ondemand.com/";
    ...
    private static String GOOD_DISC_SVC_DFLT =
            ...
            + "    \"port\": 443,\n"
            + "    \"protocol\": \"https\",\n"
            + "    \"appID\": \"com.novigo.fiori.trackerapp\"\n"
            + "}\n";
