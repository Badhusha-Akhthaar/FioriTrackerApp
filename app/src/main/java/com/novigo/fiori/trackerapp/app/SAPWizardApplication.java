package com.novigo.fiori.trackerapp.app;
...
import com.novigo.fiori.trackerapp.repository.RepositoryFactory;
...
import com.novigo.fiori.trackerapp.logon.SAPOAuthConfigProvider;
import com.novigo.fiori.trackerapp.logon.SAPOAuthTokenStore;
...
public class SAPWizardApplication extends Application {
     ...
     */
    public static final String APPLICATION_ID = "com.novigo.fiori.trackerapp";
    ...
    * URL.
    */
    public void initSettingsParameters() {
        try {
            String serviceUrl = configurationData.getServiceUrl();
            String deviceId = Settings.Secure.getString(this.getContentResolver(), Settings.Secure.ANDROID_ID);
            SettingsParameters sp = new SettingsParameters(serviceUrl, APPLICATION_ID, deviceId, APPLICATION_VERSION);
