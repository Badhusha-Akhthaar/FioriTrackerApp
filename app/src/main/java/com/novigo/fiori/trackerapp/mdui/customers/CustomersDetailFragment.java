...
import com.novigo.fiori.trackerapp.databinding.FragmentCustomersDetailBinding;
...
public class CustomersDetailFragment extends InterfacedFragment<Customer> {
    ...
    private void setDetailImage(@NonNull ObjectHeader objectHeader, @NonNull Customer customerEntity) {
        ...
        } else if (customerEntity.getDataValue(Customer.city) != null && !customerEntity.getDataValue(Customer.city).toString().isEmpty()) {
