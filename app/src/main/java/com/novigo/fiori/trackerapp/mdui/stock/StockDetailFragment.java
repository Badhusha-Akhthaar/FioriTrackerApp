...
import com.novigo.fiori.trackerapp.databinding.FragmentStockDetailBinding;
...
public class StockDetailFragment extends InterfacedFragment<Stock> {
    ...
    private void setDetailImage(@NonNull ObjectHeader objectHeader, @NonNull Stock stockEntity) {
        ...
        } else if (stockEntity.getDataValue(Stock.lotSize) != null && !stockEntity.getDataValue(Stock.lotSize).toString().isEmpty()) {
