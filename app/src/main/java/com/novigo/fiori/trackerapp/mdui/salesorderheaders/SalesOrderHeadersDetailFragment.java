...
import com.novigo.fiori.trackerapp.databinding.FragmentSalesorderheadersDetailBinding;
...
import com.novigo.fiori.trackerapp.mdui.customers.CustomersActivity;
import com.novigo.fiori.trackerapp.mdui.salesorderitems.SalesOrderItemsActivity;
...
public class SalesOrderHeadersDetailFragment extends InterfacedFragment<SalesOrderHeader> {
    ...
    private void setDetailImage(@NonNull ObjectHeader objectHeader, @NonNull SalesOrderHeader salesOrderHeaderEntity) {
        ...
        } else if (salesOrderHeaderEntity.getDataValue(SalesOrderHeader.createdAt) != null && !salesOrderHeaderEntity.getDataValue(SalesOrderHeader.createdAt).toString().isEmpty()) {
