...
import com.novigo.fiori.trackerapp.databinding.FragmentProductcategoriesDetailBinding;
...
public class ProductCategoriesDetailFragment extends InterfacedFragment<ProductCategory> {
    ...
    private void setDetailImage(@NonNull ObjectHeader objectHeader, @NonNull ProductCategory productCategoryEntity) {
        ...
        } else if (productCategoryEntity.getDataValue(ProductCategory.categoryName) != null && !productCategoryEntity.getDataValue(ProductCategory.categoryName).toString().isEmpty()) {
