...
import static com.novigo.fiori.trackerapp.logon.ActivationActionHandlerImpl.DISCOVERY_SVC_EMAIL;
import com.novigo.fiori.trackerapp.R;
import com.novigo.fiori.trackerapp.app.ConfigurationData;
...
public class LaunchScreenActionHandlerImpl extends WelcomeScreenActionHandlerImpl implements ActivityResultActionHandler {
    ...
    private boolean authenticateWithServer(Fragment fragment) {
        ...
        sapWizardApplication.initSettingsParameters();
        ...
        OAuth2Processor oAuth2Processor = new OAuth2WebViewProcessor(oAuth2Configuration);
        try {
    ...
    private void promptForProviderInput(Activity activity) {
        ...
        activationSettings.setActionHandler("com.novigo.fiori.trackerapp.logon.ActivationActionHandlerImpl");
